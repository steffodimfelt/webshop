...
<html>
  ...
  <body>
    ...
    <div class="outer_container pt-4 px-5"><h1 class="text-center">Min Admin</h1>
      <?PHP
        if (!$admin_id_in)
        {
          ...
          echo "<h3 class='text-center pb-4'>Uppdatera mina adminuppgifter</h3>";
          echo"  <div id='response' class='mb-3'></div>";
          $sql = select_one_post("admin", "*", "admin_id", $admin_id_in );
          $result = mysqli_query($conn, $sql);
          if (mysqli_num_rows($result) > 0) {while($row = mysqli_fetch_assoc($result)) {include "my_admin_form.php";}}
        }
      ?>
